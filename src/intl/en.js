...
export default {
  ...
  'sync.message.reboothint': 'Sync settings have been changed and thus junkan needs to reboot!',
  'sync.buttons.close': 'Close',
  'sync.buttons.update': 'Update',
  'sync.form.labels.dburl': 'Url of a pouch db compatible remote database',
  'sync.form.labels.dbuser': 'Remote database user',
  'sync.form.labels.dbpassword': 'Remote database password',
